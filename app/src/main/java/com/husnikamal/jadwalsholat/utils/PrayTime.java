package com.husnikamal.jadwalsholat.utils;
...
public class PrayTime {
    ...
    public PrayTime() {
        ...
        // CUSTOM (using SIHAT KEMENAG INDONESIA)
        // angles: Fajr: 20º - Isha 18º
        // Reference from MuslimPro App
        double[] Cvalues = {20, 0, 0, 0, 18};
    ...
    public static LinkedHashMap<String, String> getPrayerTimes(Context context, int index, double lat, double lng, int timeFormat) {
        ...
        /*
            Default Offset of MuslimPro App
         */
        int[] offsets = {2, -2, 2, 2, 0, 2, 2}; // {Fajr,Sunrise,Dhuhr,Asr,Sunset,Maghrib,Isha}
        prayers.tune(offsets);
